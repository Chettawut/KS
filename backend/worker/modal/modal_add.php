    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content w3-flat-turquoise">
            ...
            <div class="modal-body">
                <form name="frmAddWorker" id="frmAddWorker" method="POST" style="padding:10px;" action="javascript:void(0);" enctype="multipart/form-data">
                    <div class="form-row">
            ...
            <div class="modal-footer">
                <div class="col text-center">
                    ...
                    <button type="submit" form="frmAddWorker" class="btn btn-primary">เพิ่ม</button>
                </div>
            </div>
        </div>
    </div>
